(function() {
  var Module, VinylFile, _, async, babel, fs, parse, path, traceModule, util;
  ...
  module.exports = traceModule = function(startModuleName, config, allModules, fileLoader, callback) {
    var emitModule, es6Files, foundModuleNames, jsonFiles, resolveInlinedModule, resolveModule, resolveModuleFileName, resolveModuleName, resolveModules, textFiles;
    if (allModules == null) {
      allModules = [];
    }
    foundModuleNames = [];
    ...
    resolveModuleName = function(moduleName, relativeTo) {
      var eligiblePath, isES6, isJson, isText, relativeToFileName, slashIdx;
      if (relativeTo == null) {
        relativeTo = "";
      }
    ...
    resolveModule = function(moduleName, callback) {
      var fileName, isES6File, isJsonFile, isTextFile, module;
